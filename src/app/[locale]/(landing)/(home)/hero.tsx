...
export const Hero = async () => {
  ...
  return (
    <main className="bg-main-button relative h-[60vh] lg:h-[80vh]">
      <div className="bg-primary/20 absolute inset-0 size-full min-h-full min-w-full"></div>
      <video
        src={'/hero-video.mp4'}
        autoPlay
        muted
      ...
      />
      <div className="bg-primary/20 absolute inset-0 flex flex-col items-center justify-center gap-y-10 lg:gap-y-28">
